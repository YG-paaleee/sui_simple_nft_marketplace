...
module nft::nft_marketplace {
    ...
    entry fun list_nft_for_sale(
        ...
        dynamic_object_field::add(&mut listing.id, b"nft", nft);
    ...
    /// Purchase a listed NFT (entry function)
        ...
        //Get NFT from dynamic field before deleting listing
        let nft: DevNetNFT = dynamic_object_field::remove(&mut listing.id, b"nft");
